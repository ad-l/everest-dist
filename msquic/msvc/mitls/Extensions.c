...
FStar_List_Tot_Base_fold_left__FStar_Bytes_bytes_FStar_Bytes_bytes___uint32_t(
  FStar_Bytes_bytes (*f0)(FStar_Bytes_bytes x0, K___FStar_Bytes_bytes_uint32_t x1),
  FStar_Bytes_bytes x0,
  Prims_list__K___FStar_Bytes_bytes_uint32_t *l0
)
{
  FStar_Bytes_bytes (*f)(FStar_Bytes_bytes x0, K___FStar_Bytes_bytes_uint32_t x1) = f0;
  FStar_Bytes_bytes x = x0;
  Prims_list__K___FStar_Bytes_bytes_uint32_t *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return x;
    else if (l->tag == Prims_Cons)
    {
      ...
      return KRML_EABORT(FStar_Bytes_bytes, "unreachable (pattern matches are exhaustive in F*)");
...
static FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Prims_list__FStar_Bytes_bytes
Extensions_parseBinderList_aux(FStar_Bytes_bytes b0, Prims_list__FStar_Bytes_bytes *binders0)
{
  FStar_Bytes_bytes b = b0;
  Prims_list__FStar_Bytes_bytes *binders = binders0;
  while (true)
        ...
        else if (scrut.tag == FStar_Error_Correct)
        {
          ...
          else
          {
            ...
            *buf0 = KRML_HOST_MALLOC(sizeof (Prims_list__FStar_Bytes_bytes));
            ...
            binders = FStar_List_Tot_Base_append__FStar_Bytes_bytes(binders, buf0);
          }
        }
        else
          return
            KRML_EABORT(FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Prims_list__FStar_Bytes_bytes,
              "unreachable (pattern matches are exhaustive in F*)");
      }
      else
...
Extensions_parsePskIdentities_aux(
  FStar_Bytes_bytes b0,
  Prims_list__K___FStar_Bytes_bytes_uint32_t *psks0
)
{
  FStar_Bytes_bytes b = b0;
  Prims_list__K___FStar_Bytes_bytes_uint32_t *psks = psks0;
  while (true)
    if (Prims_op_GreaterThan(FStar_UInt32_v(FStar_Bytes_len(b)), (krml_checked_int_t)0))
      if (Prims_op_GreaterThanOrEqual(FStar_UInt32_v(FStar_Bytes_len(b)), (krml_checked_int_t)2))
      {
        ...
        else if (scrut0.tag == FStar_Error_Correct)
        {
          ...
          if
          (
            Prims_op_GreaterThanOrEqual(FStar_UInt32_v(FStar_Bytes_len(bytes)),
          ...
          )
          {
            ...
            if (scrut.tag == FStar_Error_Correct)
            {
              ...
              *buf0 = KRML_HOST_MALLOC(sizeof (Prims_list__K___FStar_Bytes_bytes_uint32_t));
              ...
              psks = FStar_List_Tot_Base_append__FStar_Bytes_bytes___uint32_t(psks, buf0);
            }
            else if (scrut.tag == FStar_Error_Error)
            {
              K___Parsers_Alert_alert_Prims_string z = scrut.val.case_Error;
              ...
              return
                KRML_EABORT(FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Prims_list__K___FStar_Bytes_bytes_uint32_t,
                  "unreachable (pattern matches are exhaustive in F*)");
          }
          else
            return
...
static FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Prims_list__FStar_Bytes_bytes
Extensions_parseAlpn_aux(Prims_list__FStar_Bytes_bytes *al0, FStar_Bytes_bytes b0)
{
  Prims_list__FStar_Bytes_bytes *al = al0;
  FStar_Bytes_bytes b = b0;
  while (true)
      ...
      if (scrut.tag == FStar_Error_Correct)
      {
        ...
        if (Prims_op_GreaterThan(FStar_UInt32_v(FStar_Bytes_len(cur)), (krml_checked_int_t)0))
        {
          ...
          *buf0 = KRML_HOST_MALLOC(sizeof (Prims_list__FStar_Bytes_bytes));
          ...
          al = FStar_List_Tot_Base_append__FStar_Bytes_bytes(al, buf0);
          b = r;
        }
        else
          return
...
FStar_List_Tot_Base_fold_left__FStar_Bytes_bytes_Parsers_ProtocolVersion_protocolVersion(
  FStar_Bytes_bytes (*f0)(FStar_Bytes_bytes x0, Parsers_ProtocolVersion_protocolVersion x1),
  FStar_Bytes_bytes x0,
  Prims_list__Parsers_ProtocolVersion_protocolVersion *l0
)
{
  FStar_Bytes_bytes (*f)(FStar_Bytes_bytes x0, Parsers_ProtocolVersion_protocolVersion x1) = f0;
  FStar_Bytes_bytes x = x0;
  Prims_list__Parsers_ProtocolVersion_protocolVersion *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return x;
    else if (l->tag == Prims_Cons)
...
*Extensions_ext_of_custom_aux(
  Prims_list__Extensions_extension_ *acc0,
  Prims_list__K___uint16_t_FStar_Bytes_bytes *uu___7_44800
)
{
  Prims_list__Extensions_extension_ *acc = acc0;
  Prims_list__K___uint16_t_FStar_Bytes_bytes *uu____0 = uu___7_44800;
  while (true)
    if (uu____0->tag == Prims_Nil)
      return acc;
    else if (uu____0->tag == Prims_Cons)
    {
      Prims_list__K___uint16_t_FStar_Bytes_bytes *t = uu____0->tl;
      FStar_Bytes_bytes b = uu____0->hd.snd;
      uint16_t h1 = uu____0->hd.fst;
      ...
      *buf = KRML_HOST_MALLOC(sizeof (Prims_list__Extensions_extension_));
      ...
      return KRML_EABORT(void *, "unreachable (pattern matches are exhaustive in F*)");
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
    __LINE__,
    "unreachable, returns inserted above");
...
*FStar_List_Tot_Base_rev_acc__Extensions_extension_(
  Prims_list__Extensions_extension_ *l0,
  Prims_list__Extensions_extension_ *acc0
)
{
  Prims_list__Extensions_extension_ *l = l0;
  Prims_list__Extensions_extension_ *acc = acc0;
  while (true)
    if (l->tag == Prims_Nil)
      return acc;
...
*Extensions_custom_of_ext_aux(
  Prims_list__K___uint16_t_FStar_Bytes_bytes *acc0,
  Prims_list__Extensions_extension_ *uu___8_45310
)
{
  Prims_list__K___uint16_t_FStar_Bytes_bytes *acc = acc0;
  Prims_list__Extensions_extension_ *uu____0 = uu___8_45310;
  while (true)
    if (uu____0->tag == Prims_Nil)
      return acc;
    else if (uu____0->tag == Prims_Cons && uu____0->hd.tag == Extensions_E_unknown_extension)
    {
      Prims_list__Extensions_extension_ *t = uu____0->tl;
      FStar_Bytes_bytes b = uu____0->hd.val.case_E_unknown_extension._1;
      FStar_Bytes_bytes hd1 = uu____0->hd.val.case_E_unknown_extension.x;
...
*FStar_List_Tot_Base_rev_acc__uint16_t___FStar_Bytes_bytes(
  Prims_list__K___uint16_t_FStar_Bytes_bytes *l0,
  Prims_list__K___uint16_t_FStar_Bytes_bytes *acc0
)
{
  Prims_list__K___uint16_t_FStar_Bytes_bytes *l = l0;
  Prims_list__K___uint16_t_FStar_Bytes_bytes *acc = acc0;
  while (true)
    if (l->tag == Prims_Nil)
      return acc;
...
FStar_List_Tot_Base_fold_left__FStar_Bytes_bytes_Extensions_extension_(
  FStar_Bytes_bytes (*f0)(FStar_Bytes_bytes x0, Extensions_extension_ x1),
  FStar_Bytes_bytes x0,
  Prims_list__Extensions_extension_ *l0
)
{
  FStar_Bytes_bytes (*f)(FStar_Bytes_bytes x0, Extensions_extension_ x1) = f0;
  FStar_Bytes_bytes x = x0;
  Prims_list__Extensions_extension_ *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
...
FStar_List_Tot_Base_find__Extensions_extension_(
  bool (*f0)(Extensions_extension_ x0),
  Prims_list__Extensions_extension_ *l0
)
{
  bool (*f)(Extensions_extension_ x0) = f0;
  Prims_list__Extensions_extension_ *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return
    ...
    else if (l->tag == Prims_Cons)
    {
      ...
      return
        KRML_EABORT(FStar_Pervasives_Native_option__Extensions_extension_,
          "unreachable (pattern matches are exhaustive in F*)");
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
    __LINE__,
...
FStar_List_Tot_Base_mem__Extensions_point_format(
  Extensions_point_format x0,
  Prims_list__Extensions_point_format *uu___7_9530
)
{
  Extensions_point_format x = x0;
  Prims_list__Extensions_point_format *uu____0 = uu___7_9530;
  while (true)
    if (uu____0->tag == Prims_Nil)
      return false;
    else if (uu____0->tag == Prims_Cons)
    {
      Prims_list__Extensions_point_format *tl1 = uu____0->tl;
      Extensions_point_format hd1 = uu____0->hd;
...
Extensions_parseExtensions_aux(
  Extensions_ext_msg mt0,
  FStar_Bytes_bytes b0,
  K___Prims_list__Extensions_extension__FStar_Pervasives_Native_option__Prims_list__FStar_Bytes_bytes
  uu____63170
)
{
  Extensions_ext_msg mt = mt0;
  FStar_Bytes_bytes b = b0;
  K___Prims_list__Extensions_extension__FStar_Pervasives_Native_option__Prims_list__FStar_Bytes_bytes
  uu____0 = uu____63170;
  while (true)
  {
    Prims_list__Extensions_extension_ *exts = uu____0.fst;
    FStar_Pervasives_Native_option__Prims_list__FStar_Bytes_bytes obinders = uu____0.snd;
      ...
      else if (scrut0.tag == FStar_Error_Correct)
      {
        ...
        )
        {
          ...
          else if (scrut.tag == FStar_Error_Error)
          {
            ...
            return
              KRML_EABORT(FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_K___Prims_list__Extensions_extension__FStar_Pervasives_Native_option__Prims_list__FStar_Bytes_bytes,
                "unreachable (pattern matches are exhaustive in F*)");
        }
        else if
        (
...
FStar_List_Tot_Base_existsb__CipherSuite_cipherSuite_(
  bool (*f0)(CipherSuite_cipherSuite_ x0),
  Prims_list__CipherSuite_cipherSuite_ *l0
)
{
  bool (*f)(CipherSuite_cipherSuite_ x0) = f0;
  Prims_list__CipherSuite_cipherSuite_ *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return false;
    else if (l->tag == Prims_Cons)
...
FStar_List_Tot_Base_existsb__TLSConstants_pskInfo(
  bool (*f0)(TLSConstants_pskInfo x0),
  Prims_list__TLSConstants_pskInfo *l0
)
{
  bool (*f)(TLSConstants_pskInfo x0) = f0;
  Prims_list__TLSConstants_pskInfo *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return false;
    else if (l->tag == Prims_Cons)
...
FStar_List_Tot_Base_fold_left__Prims_int_TLSConstants_pskInfo(
  Prims_int (*f0)(Prims_int x0, TLSConstants_pskInfo x1),
  Prims_int x0,
  Prims_list__TLSConstants_pskInfo *l0
)
{
  Prims_int (*f)(Prims_int x0, TLSConstants_pskInfo x1) = f0;
  Prims_int x = x0;
  Prims_list__TLSConstants_pskInfo *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
    ...
    else if (l->tag == Prims_Cons)
    {
      ...
      return KRML_EABORT(Prims_int, "unreachable (pattern matches are exhaustive in F*)");
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
    __LINE__,
    "unreachable, returns inserted above");
...
List_Helpers_find_aux__Extensions_extension__Extensions_extension_(
  Extensions_extension_ env0,
  bool (*f0)(Extensions_extension_ x0, Extensions_extension_ x1),
  Prims_list__Extensions_extension_ *l0
)
{
  Extensions_extension_ env = env0;
  bool (*f)(Extensions_extension_ x0, Extensions_extension_ x1) = f0;
  Prims_list__Extensions_extension_ *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return
...
Extensions_serverToNegotiatedExtensions_aux(
  TLSConstants_config cfg0,
  Prims_list__Extensions_extension_ *cExtL0,
  CipherSuite_cipherSuite_ cs0,
  FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_FStar_Bytes_bytes ri0,
  bool resuming0,
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Parsers_ProtocolVersion_protocolVersion
  rpv0,
  Prims_list__Extensions_extension_ *sExtL0
)
{
  TLSConstants_config cfg = cfg0;
  Prims_list__Extensions_extension_ *cExtL = cExtL0;
  CipherSuite_cipherSuite_ cs = cs0;
  FStar_Pervasives_Native_option__K___FStar_Bytes_bytes_FStar_Bytes_bytes ri = ri0;
  bool resuming = resuming0;
  FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Parsers_ProtocolVersion_protocolVersion
  rpv = rpv0;
  Prims_list__Extensions_extension_ *sExtL = sExtL0;
  while (true)
    ...
    else if (sExtL->tag == Prims_Cons)
    {
      ...
      return
        KRML_EABORT(FStar_Error_optResult__K___Parsers_Alert_alert_Prims_string_Parsers_ProtocolVersion_protocolVersion,
          "unreachable (pattern matches are exhaustive in F*)");
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
    __LINE__,
...
FStar_List_Tot_Base_mem__FStar_Bytes_bytes(
  FStar_Bytes_bytes x0,
  Prims_list__FStar_Bytes_bytes *uu___7_9530
)
{
  FStar_Bytes_bytes x = x0;
  Prims_list__FStar_Bytes_bytes *uu____0 = uu___7_9530;
  while (true)
    if (uu____0->tag == Prims_Nil)
      return false;
    else if (uu____0->tag == Prims_Cons)
    {
      Prims_list__FStar_Bytes_bytes *tl1 = uu____0->tl;
      FStar_Bytes_bytes hd1 = uu____0->hd;
...
FStar_List_Tot_Base_tryFind__TLSConstants_serverName(
  bool (*p0)(TLSConstants_serverName x0),
  Prims_list__TLSConstants_serverName *l0
)
{
  bool (*p)(TLSConstants_serverName x0) = p0;
  Prims_list__TLSConstants_serverName *l = l0;
  while (true)
    if (l->tag == Prims_Nil)
      return
        (
    ...
    else if (l->tag == Prims_Cons)
    {
      ...
      return
        KRML_EABORT(FStar_Pervasives_Native_option__TLSConstants_serverName,
          "unreachable (pattern matches are exhaustive in F*)");
  KRML_HOST_EPRINTF("KreMLin abort at %s:%d\n%s\n",
    __FILE__,
    __LINE__,
